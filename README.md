...
![Network Diagram](images/Project_Diagram_drawio.png)
...
### VM Environment
![VM Overview](images/Screenshot_2026-08-09_165116.png)
*DC01 and PC01 both running in VirtualBox, connected over an isolated internal network.*

### Domain Controller Configuration
![DC Properties](images/Screenshot_2026-08-08_014457.png)
...
![AD DS Prerequisites Check](images/Screenshot_2026-08-08_012233.png)
...
![ADUC Domain View](images/Screenshot_2026-08-08_015447.png)
...
![DNS Manager](images/Screenshot_2026-08-08_015403.png)
...
![Client IP Config](images/Screenshot_2026-08-09_155632.png)
...
![Connectivity Test](images/Screenshot_2026-08-09_153604.png)
...
![Domain Join Confirmation](images/Screenshot_2026-08-09_155340.png)
*Settings → System → About on PC01 showing the full device name as `PC01.lab.local`, confirming a successful domain join.*

![Domain Login](images/Screenshot_2026-08-09_154755.png)
...
![GPO Update Success](images/Screenshot_2026-08-09_174330.png)
...
![GPO Enforced — Control Panel Blocked](images/Screenshot_2026-08-09_174403.png)
...
*Built by Aryaan Sheikh — [LinkedIn](https://www.linkedin.com/in/aryaan-sheikh-74b29120b/) · [Resume](AryaanSheikhResumedocx.pdf)*
